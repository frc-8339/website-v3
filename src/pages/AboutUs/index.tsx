    ...
    <Flex align="center" direction="column">
      ...
      <Flex m="xl" align="center" direction="column">
        <Text w="80%" mt="xl" fz="h2">
          ...
          robotics competition on March 1st, 2023, in Victoria, British Columbia. Our challenge, as a team, is to dedicate hundreds of hours over the
          next few months to producing a robot capable of sophisticated, dynamic movement with the ability to follow complex commands to satisfy a
          list of tasks provided by the robotics competition. The large-scale event is known worldwide as FIRST or “For Inspiration and Recognition of
