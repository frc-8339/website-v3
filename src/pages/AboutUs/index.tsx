...
export default function AboutUs() {
  ...
  return (
    <Flex align="center" direction="column" id="about" bg="black">
      ...
      <Grid m={isMobile ? "sm" : "lg"}>
        <Grid.Col span={6}>
          <Group align="center" justify="center">
            {yearsWithPicture.map((year) => (
              <Image src={`/images/team/${year}.jpg`} h="100%" w={isMobile ? "100%" : "45%"} alt={`Penticton Robotics ${year} members`} />
            ))}
          </Group>
        </Grid.Col>
        <Grid.Col span={6}>
          <Group align="center" justify="center" gap={isMobile ? "sm" : "lg"}>
            <Image w={isMobile ? "70%" : "35%"} src={rookie2020} alt="2020 Rookie All-Star Team" />
            <Image w={isMobile ? "70%" : "35%"} src={rookieDesign2021} alt="2021 Rookie Design Award" />
            <Image w={isMobile ? "70%" : "35%"} src={creativity2024} alt="2024 Creativity Award" />
            <Image w={isMobile ? "70%" : "35%"} src={winner2025} alt="2025 Winner" />
          </Group>
        </Grid.Col>
      </Grid>
